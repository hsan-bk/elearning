...
function Listmycourses({courses, user , ping, setping}) {
...
<div>
      {selectedCourse ? (
        <MyCourseDetails course={selectedCourse} onBackButtonClick={handleBackButtonClick} user={user} ping={ping} setping={setping}/>
      ) : (
