...
function MoreCourseDetails({course, onBackButtonClick, user, ping, setping}) {
...
const handleAddToMyCourses = () => {
  const updatedAudience = [...course.audience, user._id];
  ...
  return (
    ...
    <Button variant="success" onClick={handleAddToMyCourses}>Add to my courses !</Button></div>
