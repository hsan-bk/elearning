    ...
    <div style={{backgroundColor:'#e3e5eb'}}>
        ...
        <h2 style={{color:'white'}}>Dashboard {student?student.name:<h2>...Loading</h2>} </h2>
          <Dropdown style={{paddingRight:'20px'}}>
            ...
            <Dropdown.Menu>
              ...
              <hr/>
              <Dropdown.Item href="" onClick={(id)=>{dispatch( deleteuser(id = student._id));navigate("/login")}}>Delete my account</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </header>
      ...
      <Tab.Container id="left-tabs-example" defaultActiveKey="first" >
        ...
        <Col className='sidebar' sm={3} >
          ...
          <img src={student.avatar} alt='avatar' style={{width:'120px', height:'120px', borderRadius:'50%'}} />
          <h4>{student.name}</h4>
          <h4>I am {student.role}</h4>
          <br/>
